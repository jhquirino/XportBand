//-----------------------------------------------------------------------
// <copyright file="BooleanToVisibilityConverter.cs" company="Jorge Alberto Hernández Quirino">
...
namespace XportBand.Converters
{
    ...
    /// <summary>
    /// Converter class, from <see cref="System.Boolean"/> to <see cref="Windows.UI.Xaml.Visibility"/>.
    /// </summary>
    public sealed class BooleanToVisibilityConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            bool lbValue = false;
            try { lbValue = System.Convert.ToBoolean(value); }
            catch { Boolean.TryParse(value as string, out lbValue); }
